...
func (n *ScraperParser) PortsWithUrlPaths(logger logr.Logger, name string, config interface{}) ([]components.PortUrlPaths, error) {
	return []components.PortUrlPaths{}, nil
}
